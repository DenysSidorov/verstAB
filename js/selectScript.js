        ...
        $(this).each(function() {
            ...
            if (select.prev('span.selectbox').length < 1) {
                function doSelect() {
                    ...
                    var selectbox =
                        $('<span class="selectbox" id="'+select_id+'_id" style="display:inline-block;position:relative">'+
                            '<div class="select" style="float:left;position:relative;z-index:10000"><div class="text">' + optionText + '</div>'+
                            '<b class="trigger"><i class="arrow"></i></b>'+
                            '</div>'+
                            '<div class="dropdown" style="position:absolute;z-index:99999;overflow:hidden;list-style:none">'+
                            '<ul>' + ddlist + '</ul>'+
                            '</div>'+
                            '</span>');
                    ...
                    dropdown.css({left: 0});
                    dropdown.css({top: selectHeight + 'px'});
